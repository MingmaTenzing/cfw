...
<template>
  <main class="bg-zinc-950 text-white w-full h-full">
    <div class="p-4">
      <p class="font-bold text-2xl text-center">CFW</p>
    </div>
    <!-- header -->
    ...
    <section>
      ...
      <!-- prices today list -->
      <section id="price-list-item" class="p-4 hover:bg-zinc-900 flex justify-between items-center">
        <div class="space-y-2">
          <!-- price -->
          <div>
            <p class="font-semibold">159.8</p>
            <p class="text-zinc-400 text-xs">Today</p>
          </div>
          <div>
            <p class="font-semibold">159.8</p>
        ...
        <div>
          <!-- details -->
          <p class="font-bold">Shell Reddy Express Morely</p>
          <p class="text-zinc-500">111 Broun Ave, PERTH</p>
        </div>
        <div>
          <!-- logo -->
          <img
